...
class ProductService {
  ...
  async getById(id) {
    ...
    return {
      ...
      showOnHomepage: Boolean(p.featured_on_homepage),
      image: coverImage,
      images: imgUrls,
  ...
  async create(data) {
    ...
    const res = await db.query(
      ...
      [
        ...
        data.isBestSeller ?? data.bestSeller ?? false,
  ...
  async update(id, data) {
    ...
    const res = await db.query(
      ...
      [
        ...
        data.newArrival !== undefined ? Boolean(data.newArrival) : (data.isNewArrival !== undefined ? Boolean(data.isNewArrival) : (data.is_new_arrival !== undefined ? Boolean(data.is_new_arrival) : Boolean(existing.is_new_arrival))),
